...
namespace DAL
{
    ...
    partial void DeleteThuePhong(ThuePhong instance);
		...
		public dbQLKhachSanDataContext() : 
				base(global::DAL.Properties.Settings.Default.KhachSanConnectionString5, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OngioRaChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_maKH", DbType="NVarChar(8) NOT NULL", CanBeNull=false)]
		public string maKH
		{
			get
			{
